...
const TopMenuDishes = () => {
    ...
    // })
  return (
    <div className="w-full min-h-screen flex flex-col gap-4 p-6 sm:p-10 md:p-20 bg-yellow-700">
        ...
        <div className="w-full flex flex-col sm:flex-row items-center justify-center gap-6 sm:gap-10">
            <div className="w-full sm:w-64 p-2 rounded-[40px] border-2 border-yellow-400 relative cursor-pointer bg-white hover:scale-105 hover:shadow-2xl transition duration-500 ease-in-out">
            <Image src={dish1} alt="random" className="rounded-[40px]" />
            ...
            <div className="w-full sm:w-80 p-2 rounded-[40px] border-2 border-yellow-400 relative cursor-pointer bg-white hover:scale-105 hover:shadow-2xl transition duration-500 ease-in-out">
            <Image src={dish2} alt="random" className="rounded-[40px]" />
            <div className="flex flex-col gap-2 px-4">
                <h2>Star</h2>
                <h3 className="font-extrabold text-xl">Noodles three</h3>
                <p>white plate with dried shrimps</p>
            ...
            <div className="w-full sm:w-64 p-2 rounded-[40px] border-2 border-yellow-400 relative cursor-pointer bg-white hover:scale-105 hover:shadow-2xl transition duration-500 ease-in-out">
            <Image src={dish3} alt="random" className="rounded-[40px]" />
            <div className="flex flex-col gap-2 px-4">
                <h2>Star</h2>
                <h3 className="font-extrabold text-xl">Noodles three</h3>
                <p>white plate with dried shrimps</p>
