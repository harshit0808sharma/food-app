...
const SingUp = ({setLogin}) => {
  return (
    <div className='w-[50%] h-[70vh] bg-white rounded-3xl flex shadow-black shadow-md'>
        <div className="flex flex-col items-center justify-center gap-5 bg-transparent basis-[50%]">
            ...
            <input type="text" placeholder='Enter Username' className='p-2 rounded-md bg-black bg-opacity-5 text-black outline-none'/>
            ...
            <input type="text" placeholder='Enter Confirm Password' className='p-2 rounded-md bg-black bg-opacity-5 text-black outline-none'/>
            <button className='px-6 py-2 rounded-md bg-yellow-700 text-white font-semibold'>Sign Up</button>
        </div>
        <div className="w-full h-[100%] p-5 gap-5 flex flex-col items-center justify-center bg-yellow-700 rounded-tl-[100px] rounded-bl-[100px] rounded-tr-2xl rounded-br-2xl basis-[50%]">
            ...
            <p className='text-white text-sm'>Login your accout that is already created</p>
