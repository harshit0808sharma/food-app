...
const SingUp = ({setLogin}) => {
  ...
  return (
    ...
    //         <input onChange={(e)=> setUsername(e.target.value)} type="text" placeholder='Enter Username' className='p-2 rounded-md bg-black bg-opacity-5 text-black outline-none'/>
